...
class ProductFilter:
    ...
    @staticmethod
    def filter_product_by_category(request, products, query_params):
    ...
    @staticmethod
    def filter_product_by_size(request, products, query_params):
    ...
    @staticmethod
    def filter_products_by_price(request, products, query_params):
    ...
    def filter_products(self):
        ...
        products, query_params = self.filter_products_by_price(
            self.request, products, query_params
        )
